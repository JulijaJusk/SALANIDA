...
public class GiftCardApplicationPage extends PageBase {
    ...
    public static void clickOnCheckboxTermsAndCoditions() {
        Common.clickOnElement(Locator.Salanida.GiftCardApplication.checkTermsAndConditions);
    }

    public static void clickOnButtonCheckout() {
        Common.clickOnElement(Locator.Salanida.GiftCardApplication.buttonCheckout);
    }

    public static void enterInvalidGiftCode(String invalidCodeInput) {
        Common.waitElementVisible(Locator.Salanida.GiftCardApplication.inputInvalidGiftCode, 8);
        Common.sendKeysToElement(Locator.Salanida.GiftCardApplication.inputInvalidGiftCode, invalidCodeInput);
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public static void clickOnButtonApply() {
        Common.clickOnElement(Locator.Salanida.GiftCardApplication.buttonApply);
    }

    public static String readRejectionMessage() {
        Common.waitElementVisible(Locator.Salanida.GiftCardApplication.paragraphReadRejectionMessage, 8);
        return Common.getTextFromElement(Locator.Salanida.GiftCardApplication.paragraphReadRejectionMessage);
